...
class TestPrinter(unittest.TestCase):
    ...
    def test_game_scheduled_dispatcher(self):
        ...
        """
        actual   = self.printer.get_event_string(test_data.game_scheduled_data)
        expected = ""
    ...
    def test_game_end_dispatcher(self):
        ...
        """
        actual   = self.printer.get_event_string(test_data.game_end_data)
    ...
    def test_game_official_dispatcher(self):
        ...
        """
        actual   = self.printer.get_event_string(test_data.game_official_data)
        expected = ""
        self.assertEqual(expected, actual)
    ...
    def test_faceoff_dispatcher(self):
        ...
        """
        actual   = self.printer.get_event_string(test_data.faceoff_data)
        expected = ""
        self.assertEqual(expected, actual)
    ...
    def test_stoppage_dispatcher(self):
        ...
        """
        actual   = self.printer.get_event_string(test_data.stoppage_data)
        expected = ""
        self.assertEqual(expected, actual)
    ...
    def test_shot_dispatcher(self):
        ...
        """
        actual   = self.printer.get_event_string(test_data.shot_data)
        expected = ""
        self.assertEqual(expected, actual)
    ...
    def test_hit_dispatcher(self):
        ...
        """
        actual   = self.printer.get_event_string(test_data.hit_data)
        expected = ""
        self.assertEqual(expected, actual)
    ...
    def test_blocked_shot_dispatcher(self):
        ...
        """
        actual   = self.printer.get_event_string(test_data.blocked_shot_data)
        expected = ""
        self.assertEqual(expected, actual)
    ...
    def test_giveaway_dispatcher(self):
        ...
        """
        actual   = self.printer.get_event_string(test_data.giveaway_data)
        expected = ""
        self.assertEqual(expected, actual)
    ...
    def test_takeaway_dispatcher(self):
        ...
        """
        actual   = self.printer.get_event_string(test_data.takeaway_data)
        expected = ""
        self.assertEqual(expected, actual)
    ...
    def test_missed_shot_dispatcher(self):
        ...
        """
        actual   = self.printer.get_event_string(test_data.missed_shot_data)
        expected = ""
        self.assertEqual(expected, actual)
    ...
    def test_penalty_dispatcher(self):
        ...
        """
        actual   = self.printer.get_event_string(test_data.penalty_data)
    ...
    def test_penalty_no_taker_dispatcher(self):
        ...
        """
        actual   = self.printer.get_event_string(test_data.penalty_data_no_taker)
        expected = ""
        self.assertEqual(expected, actual)
    ...
    def test_penalty_shot_dispatcher(self):
        ...
        """
        actual   = self.printer.get_event_string(test_data.penalty_shot_data)
    ...
    def test_period_ready_dispatcher(self):
        ...
        """
        actual   = self.printer.get_event_string(test_data.period_ready_data)
        expected = ""
        self.assertEqual(expected, actual)
    ...
    def test_period_start_dispatcher(self):
        ...
        """
        actual   = self.printer.get_event_string(test_data.period_start_data)
    ...
    def test_period_end_dispatcher(self):
        ...
        """
        actual   = self.printer.get_event_string(test_data.period_end_data)
    ...
    def test_period_official_dispatcher(self):
        ...
        """
        actual   = self.printer.get_event_string(test_data.period_official_data)
        expected = ""
        self.assertEqual(expected, actual)
    ...
    def test_goal_dispatcher(self):
        ...
        """
        actual   = self.printer.get_event_string(test_data.goal_data)
    ...
    def test_goal_no_scorer_dispatcher(self):
        ...
        Description:
            ...
            in the event data.
        """
        actual   = self.printer.get_event_string(test_data.goal_data_no_scorer)
        expected = ""
        self.assertEqual(expected, actual)
    ...
    def test_challenge_dispatcher(self):
        ...
        """
        actual   = self.printer.get_event_string(test_data.challenge_data)
